...
from MsneddonContigFilter4.MsneddonContigFilter4Impl import MsneddonContigFilter4
from MsneddonContigFilter4.MsneddonContigFilter4Server import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class MsneddonContigFilter4Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('MsneddonContigFilter4'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = MsneddonContigFilter4(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_MsneddonContigFilter4_" + str(suffix)
